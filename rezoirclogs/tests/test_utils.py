...
class ParseLogLineTests(unittest.TestCase):
    def test_normal(self):
        ...
        m = parse_log_line("02:16 <ciblout> je suis secretaire, c'est moi qui décide")
    ...
    def test_me(self):
        ...
        m = parse_log_line("02:16  * ciblout dit encore des conneries")
    ...
    def test_status(self):
        ...
        m = parse_log_line("01:56 -!- ciblout [cyprien@mauvaise.fois] has quit [Quit: Bon débaras.]")
